...
export class NavService implements OnDestroy {
	...
	},
	{
		title: 'Submenu', icon: 'menu', type: 'sub', active: false, children: [
			{ path: '', title: 'Submenu-1', type: 'link' },
			{
				title: 'Submenu-2', type: 'sub', active: false, children: [
					{ path: '', title: 'Submenu-2.1', type: 'link' },
					{ path: '', title: 'Submenu-2.2', type: 'link' },
				]
			},
		]
	},];
	...
	MENUITEMS: Menu[] = [
		...
		// },
		// {
		// 	title: 'Dashboard', icon: 'menu', type: 'sub', active: true, children: [
		// 		{ path: '/dashboard/overview', title: 'Products', type: 'link' },
		// 		{ path: '/dashboard/vendors', title: 'Vendors', type: 'link' },
		// 		{ path: '/dashboard/stocks', title: 'Stock', type: 'link' }
		// 	]
		// },
		// {
		// 	title: 'Products', icon: 'layers', type: 'link', path: '/dashboard/products'
		// },
		// {
		// 	title: 'Orders', icon: 'shopping-bag', type: 'link', path: '/dashboard/order'
		// },
		// {
		// 	title: 'Suppliers', icon: 'truck', type: 'link', path: '/#'
		// },
		// {
		// 	title: 'Designers', icon: 'codepen', type: 'link', path: '/#'
		// },
		// {
		// 	title: 'Users', icon: 'user', type: 'sub', active: false, children: [
		// 		{title: 'Manage Users', type: 'link', path: '/dashboard/users'},
		// 		{title: 'Manage Roles', type: 'link', path: '/dashboard/roles'}
		// 	]
		// },
		// {
		// 	title: 'Settings', icon: 'settings', type: 'sub', active: false, children: [
		// 		{ path: '/dashboard/change-password', title: 'Change Password', type: 'link' },
		// 		{ path: '/#', title: 'Update API Endpoints & Resources', type: 'link' }
		// 	]
		// },
	];
	...
	// Array
	concatItems = this.url.includes('localhost') ? this.MENUITEMS.concat(this.localMenu) : this.MENUITEMS;
	items = new BehaviorSubject<Menu[]>(this.concatItems);
	
	setItems(): void {
        this.items.next(this.concatItems);
    }
}
