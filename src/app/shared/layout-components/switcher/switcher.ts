...
export function localStorageBackUp() {
  ...
  if (localStorage.getItem('light-primary-color') !== null) {
    ...
    html?.setProperty('--primary-bg-color',localStorage.getItem('light-primary-color'));
    html?.setProperty('--primary-bg-hover',localStorage.getItem('light-primary-color'));
    html?.setProperty('--primary-bg-border',localStorage.getItem('light-primary-color'));
  }
  if (localStorage.getItem('dark-primary-color') !== null) {
    ...
    html?.setProperty('--primary-bg-color',localStorage.getItem('dark-primary-color'));
    html?.setProperty('--primary-bg-hover',localStorage.getItem('dark-primary-color'));
    html?.setProperty('--primary-bg-border',localStorage.getItem('dark-primary-color'));
  }
  if (localStorage.getItem('transparent-primary-color') !== null) {
    ...
    body?.classList.remove('light-theme');
    body?.classList.remove('dark-theme');
    html?.setProperty('--primary-bg-color',localStorage.getItem('transparent-primary-color'));
  }
  if (localStorage.getItem('transparent-bg-color') !== null) {
    body?.classList.add('transparent-theme');
    let transparent = document.getElementById('myonoffswitchTransparent') as HTMLInputElement;
    transparent.checked = true;
    ...
    body?.classList.remove('light-theme');
    body?.classList.remove('dark-theme');
    html?.setProperty('--transparent-body',localStorage.getItem('transparent-bg-color'));
  }
  if (localStorage.getItem('transparent-bgImg-primary-color') !== null || localStorage.getItem('BgImage') !== null) {
    body?.classList.add('transparent-theme');
    let transparent = document.getElementById('myonoffswitchTransparent') as HTMLInputElement;
    transparent.checked = true;
    ...
    body?.classList.remove('light-theme');
    body?.classList.remove('dark-theme');
    let img:any = localStorage.getItem('BgImage');
    html?.setProperty('--primary-bg-color',localStorage.getItem('transparent-bgImg-primary-color'));
  ...
  if (localStorage.getItem('TransparentTheme') !== null ) {
    let transparent = document.getElementById('myonoffswitchTransparent') as HTMLInputElement;
    transparent.checked = true;
    body?.classList.add('transparent-theme');
...
export function updateChanges(){
  ...
  //get variable
	myVarVal  =  localStorage.getItem("light-primary-color") || localStorage.getItem("dark-primary-color") || localStorage.getItem("transparent-primary-color") || localStorage.getItem("transparent-bgImg-primary-color") || primaryColorVal;
